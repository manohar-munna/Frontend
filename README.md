...
- The next scroll phase moves the phone left and tilts its top to the left. The WebGL canvas stays at a fixed size during the move. Once the phone settles, the view pushes into the main camera and reveals a six-blade variable-aperture shutter instead of an exploded lens diagram.
