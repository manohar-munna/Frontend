...
const finishes: { id: Finish; name: string; color: string }[] = [
  ...
  { id: "pearl", name: "Pearl", color: "#e5e4de" },
  { id: "sage", name: "Sage", color: "#899081" },
  { id: "stone", name: "Stone", color: "#b7b1a6" },
];
